...
```mermaid
graph TD
    L1(🟢 Cognitive Explorer) --> L2(🔵 Sense Builder)
    L2 --> L3(🟣 Cognitive Engineer)
    L3 --> L4(⚫ Strategic Cooperator)
...
=== "🟢 Level 1: Explorer"
    <div class="feature-card" style="border-left: 5px solid #e7ae4c;">
        ...
        <p><em>Reward: "Junior Analyst" Badge</em></p>
    </div>
...
1.  **Find a Mission**: Go to the [Issues](https://github.com/atlantyde-labs/cognitive-suite/issues) tab and filter by the `learning-task` label.
