...
```mermaid
graph TD
    Core(🏛️ ATLANTYDE) --> SL(🏢 SL Tecnológica)
    Core --> Coop(🤝 Cooperativa de Trabajo)
    Core --> Fund(🎓 Fundación Cultural)

    SL --> Ops[GitOps & Infra]
    Coop --> Lab[Labs Educativos & IA]
    Fund --> Cult[Legado Cultural & Ética]
...
<div class="features-grid features-grid--compact">
    <div class="feature-card">
        ...
        <p>Desde el <strong>Sur de Europa (Andalucía)</strong>, orquestando una visión donde la tecnología sirve al humano, no al revés.</p>
    </div>
    <div class="feature-card">
